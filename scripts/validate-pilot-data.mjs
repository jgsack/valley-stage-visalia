...
assert.equal(monitor.sources.length, 5, "the daily pilot must monitor five sources");
assert.equal(snapshot.sources.length, 5, "the site must show all five pilot sources");
